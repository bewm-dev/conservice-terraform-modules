...
variable "secret_recovery_window_in_days" {
  description = "Recovery window (days) for the deleted API key Secrets Manager secret. Platform default is 7 (SOC2-aligned). Set to 0 ONLY for non-prod sandboxes where rapid teardown/re-scaffold is required."
  type        = number
  default     = 7
